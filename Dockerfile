...
RUN R -q -e "remotes::install_version('fs', version = '1.6.4', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('MASS', version = '7.3-9', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('rlang', version = '1.1.3', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('xfun', version = '0.44', upgrade = FALSE)"
...
RUN R -q -e "remotes::install_version('crul', version = '1.4.2', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('covr', version = '3.6.4', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('ggplot2', version = '3.5.1', upgrade = FALSE)" && \
