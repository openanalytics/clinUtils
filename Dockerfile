...
RUN R -q -e "remotes::install_version('rlang', version = '1.1.3', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('xfun', version = '0.43', upgrade = FALSE)"
...
RUN R -q -e "remotes::install_version('htmltools', version = '0.5.8.1', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('systemfonts', version = '1.0.6', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('tinytex', version = '0.50', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('knitr', version = '1.46', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('bslib', version = '0.7.0', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('ragg', version = '1.3.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('stringr', version = '1.5.1', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('tidyselect', version = '1.2.1', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('gfonts', version = '0.2.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('ggplot2', version = '3.5.0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('waldo', version = '0.5.2', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('plotly', version = '4.10.4', upgrade = FALSE)" && \
