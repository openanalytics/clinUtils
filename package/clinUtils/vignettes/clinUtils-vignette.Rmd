...
Please note that the interactive outputs (table/visualization) in this vignette are only included if [Pandoc](https://pandoc.org/) 
is available (pre-requisite for R Markdown). 
